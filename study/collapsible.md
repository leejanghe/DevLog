...
///...생략
 { 
           listShow ? currList.map(item => (
               ...
               <div key={item.id} className='withdrawalSummaryItem client'>
                  ...
                  
                   {
                       ...
                       <div className='statusClient'>
                           ...
                           <span onClick={()=>onClickShowData(item.id)}><KeyboardArrowDownIcon/></span>
                       </div>
                       )
               ...
               {
                 showDetailData === item.id && showCollapsible && <CollapsibleData id={item.id}/>
               }
               </>
